class GridView {
    /**
     *  properties
     *  @param[array] _tableClass - css, класи, офрмлення
     *  @param[array] data - вхіжні дані
     *  @param[array] attribute - керуємо що виводимо і як з вхідних даних
     *  @param[array] _element - куди виводити таблицю
     *  @param[array] _header - заголовок таблиці
     *  @param[array] _headerClass - css класи заголовку
     */
    constructor() {
        this._header = '';
        this._headerClass = [];
    ...
    */
    ...
    render(data) {
        ...
        for (let i = 0; i < this.data.length; i++) {
            let dataArr = this.data[i]; // одна строка даних
